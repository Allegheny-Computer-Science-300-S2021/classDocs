...
def getVersionNumber():
	...
	myVersionNumber_str = input(myPrompt_str)
#	print(White) # set colour back to regular white
	return myVersionNumber_str # send this number back to the calling function
...
def runBlast(versionNumber_str):
	...
	myResults = NCBIWWW.qblast("blastn", "nt", versionNumber_str)
